...
import styles from "@/pages/historico/[id]/historico.module.css"
        ...
        <>
            ...
            <main className={styles.main_historico}>
                <section className={styles.container_historico}>
                    ...
                    {historico === null ? (
                        <p className={styles.mensagem}>Carregando historico...</p>
                    ) : historico.length === 0 ? (
                        <p className={styles.mensagem}> O produto não contém histórico de alteração.</p>
                    ) : (
